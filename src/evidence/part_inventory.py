...
def _paintable_panel_catalog(label_maps: dict[str, dict[str, Any]]) -> dict[str, Any]:
    panels = {
        "main_body_top_quadrants": _catalog_panel(
            ...
            symmetry_policy="paired TL/TR/BL/BR named atlas zones; runtime left/right interpretation pending smoke",
        ...
        "nose_identity_panel": _catalog_panel(
            ...
            safe_design_scale="broad_identity_surface",
            symmetry_policy="single named nose zone; use centered graphics unless TMUF review accepts asymmetry",
        ...
        "center_spine": _catalog_panel(
            ...
            symmetry_policy="GBuffer LAT/X center symmetry; experimental until calibration smoke",
        ...
        "sidepod_blades": _catalog_panel(
            ...
            safe_design_scale="broad_identity_surface",
            symmetry_policy="paired L/R named zones with GBuffer side-band clipping experimental until smoke",
        ...
        "engine_rear_deck": _catalog_panel(
            ...
            safe_design_scale="medium_to_broad_accent",
            symmetry_policy="generated rear/deck token zones plus LAT/X mirrored offset bands; runtime symmetry unproven",
        ...
        "tailwing_bands": _catalog_panel(
            ...
            safe_design_scale="medium_to_broad_accent",
            symmetry_policy="paired L/R tailwing labels plus under-border zone; keep bands mirrored until review",
        ...
        "front_mudguard_caps": _catalog_panel(
            ...
            safe_design_scale="medium_to_broad_accent",
            symmetry_policy="named front guard group; front split by LEN/Z remains experimental",
        ...
        "rear_mudguard_caps": _catalog_panel(
            ...
            safe_design_scale="medium_to_broad_accent",
            symmetry_policy="named rear guard group; rear split by LEN/Z remains experimental",
        ...
        "side_wings": _catalog_panel(
            ...
            symmetry_policy="named side wing and underside labels; use balanced accent colors until TMUF review",
        ...
        "mirrors_and_holders": _catalog_panel(
            ...
            symmetry_policy="named mirror/holder atlas zones; tiny visibility must be visually accepted",
        ...
        "helmet_and_visor": _catalog_panel(
            ...
            safe_design_scale="medium_accent_surface",
            symmetry_policy="paired helmet/glass quadrants; keep subordinate to car-body symmetry",
        ...
        "underbody_dark": _catalog_panel(
            ...
            symmetry_policy="named underside quadrants and underplate zones; support material with no hero asymmetry",
        ...
        "licence_plate_blocks": _catalog_panel(
            name="licence_plate_blocks",
            source_status="proven_local_label_map",
            source_maps=["psd_parts"],
            source_zones=["LicencePlate", "LicencePlateBlock"],
            design_role="abstract plaque blocks, small color balance fields, and no-text graphic anchors",
            safe_design_scale="medium_accent_surface",
            symmetry_policy="named plaque zones only; no runtime placement claim before smoke",
            geometry_constraints=["named PSD licence plate zones only"],
            proof_notes=["no real sponsor text or copied trade dress; texture readability still requires TMUF review"],
            label_maps=label_maps,
        ),
        "side_vent_inside": _catalog_panel(
            name="side_vent_inside",
            source_status="proven_local_label_map",
            source_maps=["psd_parts"],
            source_zones=["BigSideVentOneInSideColor"],
            design_role="small vent interior accent and dark technical inset",
            safe_design_scale="small_detail_surface",
            symmetry_policy="single named vent zone; use as restrained accent until visibility is accepted",
            geometry_constraints=["named PSD side vent zone only"],
            proof_notes=["small area atlas evidence only; not a proof of visible vent depth in TMUF"],
            label_maps=label_maps,
        ),
        "rear_wheel_diffuse_blocks": _catalog_panel(
            name="rear_wheel_diffuse_blocks",
            source_status="proven_local_label_map",
            source_maps=["psd_parts"],
            source_zones=["RearWheelsSideBlock", "KNob.Gouing.inside.Rear.wheel"],
            design_role="stock Diffuse rear wheel-adjacent blocks and tiny mechanical color echoes",
            safe_design_scale="small_to_medium_probe_surface",
            symmetry_policy="named wheel-adjacent atlas zones only; not a wheel/tyre route claim",
            geometry_constraints=["named PSD wheel-adjacent zones only"],
            proof_notes=["not Details.dds, tyre sidewall, tread, hub material, or custom wheel proof"],
            label_maps=label_maps,
        ),
        "front_mudguard_edge_details": _catalog_panel(
            name="front_mudguard_edge_details",
            source_status="proven_local_label_map",
            source_maps=["psd_parts"],
            source_zones=["FrontMudguardEdgeColor", "FrontMudguardUnderColor", "FrontMudguards.Inside"],
            design_role="front guard pinstripe edge, underside fill, and inner accent details",
            safe_design_scale="medium_accent_surface",
            symmetry_policy="front guard named detail zones; keep paired with cap colors until visual review",
            geometry_constraints=["named PSD front mudguard detail zones only"],
            proof_notes=["front detail labels are proven atlas evidence; in-game seam quality remains unproven"],
            label_maps=label_maps,
        ),
        "rear_mudguard_edge_details": _catalog_panel(
            name="rear_mudguard_edge_details",
            source_status="proven_local_label_map",
            source_maps=["psd_parts"],
            source_zones=["RearMudguardsedgeColor", "RearMudguardsTip", "RearMudguardUnderColor", "RearMudGuardsInside"],
            design_role="rear guard pinstripe edge, tip highlight, and underside fill",
            safe_design_scale="medium_accent_surface",
            symmetry_policy="rear guard named detail zones; mirror with front/rear rhythm until review",
            geometry_constraints=["named PSD rear mudguard detail zones only"],
            proof_notes=["rear detail labels are proven atlas evidence; in-game seam quality remains unproven"],
            label_maps=label_maps,
        ),
        "nose_deck_generated_panels": _catalog_panel(
            name="nose_deck_generated_panels",
            source_status="mixed_generated_labels_and_experimental_gbuffer",
            source_maps=["panels_high"],
            source_zones=["nose_deck_C_84", "nose_deck_C_85", "nose_deck_C_09", "nose_deck_C_92"],
            design_role="front deck blocks, wedge clipping, and large nose-adjacent color surfaces",
            safe_design_scale="medium_to_broad_accent",
            symmetry_policy="generated nose/deck token zones; use mirrored/centered graphics until TMUF smoke",
            geometry_constraints=["generated nose/deck tokens", "high LEN/Z front placement remains experimental"],
            proof_notes=["generated panel tokens are local segmentation evidence, not stock semantic truth"],
            label_maps=label_maps,
            include_gbuffer=True,
        ),
        "nose_floor_generated_panels": _catalog_panel(
            name="nose_floor_generated_panels",
            source_status="mixed_generated_labels_and_experimental_gbuffer",
            source_maps=["panels_fine"],
            source_zones=["nose_floor_C_09", "nose_floor_C_33", "nose_floor_C_34", "nose_floor_C_149"],
            design_role="front floor returns, lower wedge continuation, and dark/bright underside split probes",
            safe_design_scale="broad_support_surface",
            symmetry_policy="generated nose/floor token zones; not a runtime underside visibility claim",
            geometry_constraints=["generated nose/floor tokens", "HGT/Y lower placement remains experimental"],
            proof_notes=["use for probe and support fields; exact TMUF visibility remains smoke-pending"],
            label_maps=label_maps,
            include_gbuffer=True,
        ),
        "nose_side_generated_panels": _catalog_panel(
            name="nose_side_generated_panels",
            source_status="mixed_generated_labels_and_experimental_gbuffer",
            source_maps=["panels_high"],
            source_zones=["nose_side_C_04", "nose_side_C_83"],
            design_role="front side sweeps and large lower-side color returns",
            safe_design_scale="broad_identity_surface",
            symmetry_policy="generated nose/side token zones; side interpretation pending smoke",
            geometry_constraints=["generated nose/side tokens", "LAT/X side split remains experimental"],
            proof_notes=["broad atlas areas support large graphics; exact side wrapping remains unproven"],
            label_maps=label_maps,
            include_gbuffer=True,
        ),
        "mid_deck_generated_panels": _catalog_panel(
            name="mid_deck_generated_panels",
            source_status="mixed_generated_labels_and_experimental_gbuffer",
            source_maps=["panels_high"],
            source_zones=["mid_deck_C_79", "mid_deck_C_48", "mid_deck_C_82", "mid_deck_C_78"],
            design_role="cockpit-adjacent deck panels, roof flow breaks, and mid-body geometric blocks",
            safe_design_scale="broad_identity_surface",
            symmetry_policy="generated mid/deck token zones; cockpit/deck reading pending TMUF smoke",
            geometry_constraints=["generated mid/deck tokens", "HGT/Y upper placement remains experimental"],
            proof_notes=["large local segmentation evidence; no exact cockpit seam claim until visual review"],
            label_maps=label_maps,
            include_gbuffer=True,
        ),
        "mid_side_generated_panel": _catalog_panel(
            name="mid_side_generated_panel",
            source_status="mixed_generated_labels_and_experimental_gbuffer",
            source_maps=["panels_high"],
            source_zones=["mid_side_C_02"],
            design_role="large mid-side field for readable speed blades and blank sponsor-like geometry without text",
            safe_design_scale="broad_identity_surface",
            symmetry_policy="single broad generated mid/side token zone; side split remains GBuffer-dependent",
            geometry_constraints=["generated mid/side token", "LAT/X side split remains experimental"],
            proof_notes=["broad area is useful for preview composition; TMUF side wrap remains smoke-pending"],
            label_maps=label_maps,
            include_gbuffer=True,
        ),
        "mid_floor_generated_panels": _catalog_panel(
            name="mid_floor_generated_panels",
            source_status="mixed_generated_labels_and_experimental_gbuffer",
            source_maps=["panels_fine"],
            source_zones=["mid_floor_C_35", "mid_floor_C_38", "mid_floor_C_36"],
            design_role="mid-floor support blocks, lower shadow fields, and underside accent probes",
            safe_design_scale="medium_to_broad_support_surface",
            symmetry_policy="generated mid/floor token zones; floor visibility remains unproven",
            geometry_constraints=["generated mid/floor tokens", "HGT/Y lower placement remains experimental"],
            proof_notes=["support material only before TMUF screenshot acceptance"],
            label_maps=label_maps,
            include_gbuffer=True,
        ),
        "rear_side_generated_panels": _catalog_panel(
            name="rear_side_generated_panels",
            source_status="mixed_generated_labels_and_experimental_gbuffer",
            source_maps=["panels_fine"],
            source_zones=["rear_side_C_30", "rear_side_C_152", "rear_side_C_154", "rear_side_C_153"],
            design_role="rear side sweeps, color echoes, and side-to-tail transitions",
            safe_design_scale="medium_to_broad_accent",
            symmetry_policy="generated rear/side token zones; mirror by LAT/X until smoke proves wrap",
            geometry_constraints=["generated rear/side tokens", "low LEN/Z rear placement remains experimental"],
            proof_notes=["good candidate for symmetric rear side panels, but exact TMUF interpretation is pending"],
            label_maps=label_maps,
            include_gbuffer=True,
        ),
        "rear_floor_generated_panels": _catalog_panel(
            name="rear_floor_generated_panels",
            source_status="mixed_generated_labels_and_experimental_gbuffer",
            source_maps=["panels_high"],
            source_zones=["rear_floor_C_15", "rear_floor_C_17", "rear_floor_C_36"],
            design_role="rear floor shadows, dark support fields, and low rear accent returns",
            safe_design_scale="medium_to_broad_support_surface",
            symmetry_policy="generated rear/floor token zones; lower visibility pending TMUF smoke",
            geometry_constraints=["generated rear/floor tokens", "low LEN/Z and low HGT/Y placement remain experimental"],
            proof_notes=["support-only until real rear/lower screenshots prove readability"],
            label_maps=label_maps,
            include_gbuffer=True,
        ),
        "rear_deck_fine_louver_rows": _catalog_panel(
            name="rear_deck_fine_louver_rows",
            source_status="mixed_generated_labels_and_experimental_gbuffer",
            source_maps=["panels_fine"],
            source_zones=["rear_deck_C_140", "rear_deck_C_118", "rear_deck_C_122", "rear_deck_C_146", "rear_deck_C_133"],
            design_role="fine rear deck louver rows, paired glow blocks, and technical vent rhythm",
            safe_design_scale="medium_accent_surface",
            symmetry_policy="generated rear/deck fine tokens with LAT/X mirrored offset bands; runtime rows unproven",
            geometry_constraints=["generated rear/deck tokens", "low LEN/Z", "high HGT/Y", "LAT/X mirrored offset bands"],
            proof_notes=["generated panel tokens support louver-like probes only; exact in-game rows need TMUF screenshots"],
            label_maps=label_maps,
            include_gbuffer=True,
        ),
    }
